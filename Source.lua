...
function Library:CreateWindow(title, color)
    ...
    title_18.Font = Enum.Font.Arcade
    title_18.Text = title
        ...
        function TabTypes:CreateGroupbox(name, side)
            ...
            function GroupTypes:CreateToggle(name, callback)
                ...
                function ToggleTypes:CreateKeyBind(def, callback)
                    ...
                    bindtext.Font = Enum.Font.Arcade
                    bindtext.Text = "[ " .. def .. " ]"
            ...
            function GroupTypes:CreateSlider(name, min, max, def, callback)
                ...
                title_15.ZIndex = 0
                title_15.Font = Enum.Font.Arcade
                title_15.Text = name
            ...
            function GroupTypes:CreateButton(name, callback)
                ...
                title_16.Font = Enum.Font.Arcade
                title_16.Text = name
            ...
            function GroupTypes:CreateColorPicker(name, def, callback)
                ...
                title_17.Font = Enum.Font.Arcade
                title_17.Text = name
        ...
        function TabTypes:CratePlayerList(showbuttons, events)
            ...
            local function CreatePlayerCard(Name, UserId, MemberShipType, TeamColor)
                ...
                if (showbuttons) then
                    ...
                    whitelist.Font = Enum.Font.Arcade
                    whitelist.Text = ""
                    ...
                    blacklist.Font = Enum.Font.Arcade
                    blacklist.Text = ""
                    ...
                    prioritize.Font = Enum.Font.Arcade
                    prioritize.Text = ""
                    ...
                    unprioritize.Font = Enum.Font.Arcade
                    unprioritize.Text = ""
